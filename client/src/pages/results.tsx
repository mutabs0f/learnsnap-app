...
export default function ResultsPage() {
  ...
  const baseXP = Math.round(percentage * 2.5);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-amber-100 flex flex-col relative overflow-hidden" dir="rtl">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12 relative z-10">
        ...
        <Card className="w-full max-w-sm md:max-w-md mb-8 shadow-xl border-0 bg-white/90 backdrop-blur-sm">
        ...
        <Card className="w-full max-w-sm md:max-w-md mb-8 bg-gradient-to-r from-blue-500 to-purple-500 text-white border-0 shadow-lg">
