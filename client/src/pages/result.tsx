...
export default function ResultPage() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-cyan-50 to-blue-50 dark:from-gray-900 dark:via-emerald-900 dark:to-gray-900 flex items-center justify-center">
        <motion.div
