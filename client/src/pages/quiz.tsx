...
export default function Quiz() {
  ...
  const [showLessonIntro, setShowLessonIntro] = useState(true); // Show lesson first
      ...
      <div className="min-h-screen bg-gradient-to-br from-duo-green/5 via-white to-duo-blue/5 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 flex flex-col" dir="rtl">
        ...
        <footer className="sticky bottom-0 bg-white dark:bg-gray-900 border-t-2 border-duo-gray-light dark:border-gray-800 p-4 pb-8">
          <div className="w-full max-w-5xl mx-auto px-4 lg:px-8">
            <Button
              className="w-full h-14 rounded-xl text-xl font-black bg-duo-green hover:bg-duo-green-dark text-white transition-all shadow-[0_4px_0_0_#3FAE00] active:translate-y-1 active:shadow-none"
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="text-duo-gray hover:text-red-500"
          ...
          <Card className="mb-8 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border-2 border-duo-gray-light dark:border-gray-700 overflow-hidden">
            <CardContent className="p-8 text-center">
              <p 
                className="text-xl md:text-2xl font-bold text-gray-800 dark:text-gray-100 leading-relaxed"
      ...
      {!showFeedback && (
        <footer className="fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t-2 border-duo-gray-light dark:border-gray-800 p-4 pb-8 z-40">
          <div className="w-full max-w-5xl mx-auto px-4 lg:px-8">
            <Button
              className={`
                w-full h-14 rounded-xl text-xl font-black transition-all shadow-[0_4px_0_0_#3FAE00]
                ${selectedAnswer 
                  ? 'bg-duo-green hover:bg-duo-green-dark text-white active:translate-y-1 active:shadow-none' 
                  : 'bg-duo-gray-light text-duo-gray dark:bg-gray-800 cursor-not-allowed shadow-none opacity-50'
                }
              `}
        ...
        {showFeedback && (
          ...
          >
            <div className="w-full max-w-5xl mx-auto px-4 lg:px-8">
              ...
              <button
                className="w-full h-14 rounded-xl text-xl font-black bg-white text-gray-800 hover:bg-gray-100 transition-all shadow-[0_4px_0_0_rgba(0,0,0,0.3)] active:translate-y-1 active:shadow-none border-2 border-white/80"
                onClick={handleNext}
