...
import { ArrowRight, Bell, BookOpen, Trophy, TrendingUp, Flame, Check, CheckCheck, Home } from "lucide-react";
      ...
      <header className="bg-white border-b sticky top-0 z-50">
        <div className="max-w-3xl mx-auto px-4">
          <div className="flex items-center h-16 gap-4">
            <Link href="/">
              <Button variant="ghost" size="icon" data-testid="button-home" title="الصفحة الرئيسية">
